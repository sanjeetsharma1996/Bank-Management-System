...
# customer Create A New Account
 ...
 # Register customer login our Account 
...
# Transfer cash amount to another account 
...
# if user choose option 1 then login our Account
    if user == 1:
        print("Logging in")
